...
- 🔒 [**Gestor de Tareas con Seguirdad**](https://github.com/AlexAlonsoM/Gestor-de-Tareas-con-Seguridad): Dashboard con gráficos interactivos, notificaciones, logs de eventos y grafo de relaciones. (React + PHP + MySQL)  
...
- 📊 [**MyWatchlist App**](https://github.com/AlexAlonsoM/MyWatchlist): App móvil de trading con gráfico, búsqueda, favoritos y modo claro/oscuro. (React Native + TS + Zustand)
